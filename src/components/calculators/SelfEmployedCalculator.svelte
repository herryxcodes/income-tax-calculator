...
<div class="calculator-wrapper">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
    <!-- Inputs -->
    <div class="space-y-5">
      <h2 class="text-lg font-semibold text-gray-900">Your Self-Employment Income</h2>
      ...
      <div>
        ...
        <p class="text-xs text-gray-400 mt-1">Home office, vehicle, supplies, insurance, etc.</p>
      </div>

      <!-- Net income callout -->
      {#if grossRevenue > 0}
        <div class="bg-gray-50 rounded-lg p-3 flex justify-between items-center">
          <span class="text-sm text-gray-600">Net Self-Employment Income</span>
          <span class="text-lg font-bold text-gray-900">{formatCurrency(netSelfEmploymentIncome)}</span>
        </div>
      {/if}

      <div>
        <label for="rrsp" class="block text-sm font-medium text-gray-700 mb-1">
          RRSP Contribution <span class="text-gray-400 font-normal">(optional)</span>
        </label>
        <div class="relative">
          <span class="absolute left-3 top-2.5 text-gray-400">$</span>
          <input
      ...
      {#if showEmployment}
        <div class="pl-3 border-l-2 border-blue-100">
          <label for="employment" class="block text-sm font-medium text-gray-700 mb-1">Employment Income (T4)</label>
          <div class="relative">
            <span class="absolute left-3 top-2.5 text-gray-400">$</span>
            <input
              id="employment"
    ...
    <div>
      {#if result && netSelfEmploymentIncome > 0}
        <div class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 space-y-5">
          <h2 class="text-lg font-semibold text-gray-900">Your Self-Employment Tax</h2>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm">
              <p class="text-sm text-gray-500">Monthly Take-Home</p>
              <p class="text-xl font-bold text-gray-900">{formatCurrency(monthlyTakeHome)}</p>
            </div>
            <div class="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div class="bg-white rounded-xl p-4 shadow-sm border-l-4 border-orange-400">
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                <span class="text-gray-600">Employee portion (5.95%)</span>
                <span class="font-medium">{formatCurrency(cpp1EmployeeHalf)}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Employer portion (5.95%)</span>
          ...
          <!-- Full tax breakdown -->
          <div class="bg-white rounded-xl p-4 shadow-sm">
            <h3 class="text-sm font-semibold text-gray-700 mb-3">Full Tax Breakdown</h3>
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
              ...
              <div class="flex justify-between">
                <span class="text-gray-600">{isQuebec ? "QPP" : "CPP"} (both halves)</span>
                <span class="font-medium">{formatCurrency(result.cppContributions + result.cpp2Contributions)}</span>
              </div>
              {#if result.cpp2Contributions > 0}
                <div class="flex justify-between pl-4">
                  <span class="text-gray-400 text-xs">Includes enhanced contributions on income above $71,300</span>
                </div>
              {/if}
              <div class="flex justify-between">
              ...
              {#if result.qpipPremiums > 0}
                <div class="flex justify-between">
                  <span class="text-gray-600">QPIP</span>
          ...
          <!-- Quarterly Installments -->
          <div class="bg-white rounded-xl p-4 shadow-sm">
            <h3 class="text-sm font-semibold text-gray-700 mb-3">Quarterly Installments</h3>
          ...
          <div class="bg-white rounded-xl p-4 shadow-sm {mustRegisterGST ? 'border-l-4 border-red-400' : 'border-l-4 border-green-400'}">
            <h3 class="text-sm font-semibold text-gray-700 mb-1">GST/HST Registration</h3>
            {#if mustRegisterGST}
          ...
          <div class="bg-blue-50 rounded-xl p-4 border border-blue-100">
            <h3 class="text-sm font-semibold text-blue-900 mb-1">Filing Deadline</h3>
          ...
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-sm font-semibold text-gray-900 group-hover:text-green-700 transition">File your self-employed return</p>
                <p class="text-xs text-gray-500 mt-0.5">Wealthsimple Tax handles T2125 — file free</p>
              </div>
      ...
      {:else}
        <div class="bg-gray-50 rounded-2xl p-8 text-center">
          <p class="text-gray-400 text-lg">Enter your revenue and expenses</p>
          <p class="text-gray-300 text-sm mt-2">See your full self-employment tax breakdown</p>
        </div>
      {/if}
    </div>
  </div>
